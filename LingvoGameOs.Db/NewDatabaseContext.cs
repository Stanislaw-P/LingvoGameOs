...
{
    public class NewDatabaseContext : IdentityDbContext<User>
    {
        ...
        public NewDatabaseContext(DbContextOptions<NewDatabaseContext> options) : base(options)
        {
            Database.Migrate();
        }
        ...
        j => j
            ...
            // он не создается в бд
            var user = new User { Email = "MaratTest@mail.ru", UserName = "MaratTest@mail.ru", Name = "Марат", Surname = "Какой-то" };
